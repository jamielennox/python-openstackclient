...
from openstackclient.api import auth as osc_auth
...
class OpenStackShell(app.App):
    ...
    def initialize_app(self, argv):
        ...
        * authenticate against Identity if requested
        ...
        auth_plugin = auth.load_from_argparse_arguments(self.options)

        self.session = osc_auth.Session.load_from_cli_options(self.options,
                                                              auth=auth_plugin)
